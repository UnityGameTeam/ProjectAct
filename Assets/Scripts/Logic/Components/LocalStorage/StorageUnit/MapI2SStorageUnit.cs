...
{
    public class MapI2SStorageUnit : LocalStorageUnit
    {
        public static readonly short ValueType = 5;
        ...
        public MapI2SStorageUnit(Dictionary<int, string> value)
        {
            Value = value;
        }
        ...
        public static KeyValuePair<string, LocalStorageUnit> ParseData(byte[] dataBuff, ref int offset)
        {
            ...
            var value = new Dictionary<int, string>(valueCount);
            for (int i = 0; i < valueCount; ++i)
            {
                var datakey = BitConverter.ToInt32(dataBuff, offset);
                offset += 4;
            ...
            return new KeyValuePair<string, LocalStorageUnit>(key, new MapI2SStorageUnit(value));
        }
        ...
        public override int ToBinaryData(string key, ref byte[] dataBuff, int offset)
        {
            ...
            var value = Value as Dictionary<int, string>;
