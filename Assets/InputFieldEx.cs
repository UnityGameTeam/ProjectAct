...
namespace UguiExtensions
{
        ...
        ICanvasElement
    {
        ...
        {
            None,             //不使用半屏模式
            ImmersiveMode,    //沉浸式半屏模式，看上去与ui融合,暂时不支持ugui
            NonImmersiveMode, //非沉浸模式，游戏顶部有android的原生输入框
        }

        private static InputFieldEx s_CurrentActiveInputFieldFx; //用于半屏模式保存当前激活的InputFieldEx

        public static InputFieldEx CurrentActiveInputFieldFx
        {
            get { return s_CurrentActiveInputFieldFx; }
            set
            {
                if (s_CurrentActiveInputFieldFx != value)
                {
                    if (s_CurrentActiveInputFieldFx != null)
                    {
                        s_CurrentActiveInputFieldFx.DeactivateInputField();
                    }

                    s_CurrentActiveInputFieldFx = value;
                }
            }
        }
        ...
        {
            get { return m_HalfScreenHintText; }
            set
            {
                if (m_HalfScreenHintText != value)
                {
                    m_HalfScreenHintText = value;
                }
            }
        }

        public string HalfScreenTitleTipText
        {
            get { return m_HalfScreenTitleTipText; }
            set
            {
                if (m_HalfScreenTitleTipText != value)
                {
                    m_HalfScreenTitleTipText = value;
                }
            }
        }

        public string HalfScreenButtonOkText
        {
            get { return m_HalfScreenButtonOkText; }
            set
            {
                if (m_HalfScreenButtonOkText != value)
                {
                    m_HalfScreenButtonOkText = value;
                }
            }
        }

        public string HalfScreenButtonCancelText
        {
            get { return m_HalfScreenButtonCancelText; }
            set
            {
                if (m_HalfScreenButtonCancelText != value)
                {
        ...
        protected virtual void LateUpdate()
        {
            ...
            if (m_HalfScreenMode != HalfScreenMode.None)
            {
                if (CurrentActiveInputFieldFx != null && CurrentActiveInputFieldFx != this)
                {
                    OnDeselect(null);
                }
                return;    
        ...
        private bool MayDrag(PointerEventData eventData)
        {
            ...
            return IsActive() &&
                   ...
                   m_Keyboard == null && (!(m_HalfScreenMode != HalfScreenMode.None) || CurrentActiveInputFieldFx != this);
#else
            return IsActive() &&
                   IsInteractable() &&
                   eventData.button == PointerEventData.InputButton.Left &&
        ...
        protected EditState KeyPressed(UnityEngine.Event evt)
        {
        ...
        /// </summary>
        private UnityEngine.Event m_ProcessingEvent = new UnityEngine.Event();
        ...
        public virtual void OnUpdateSelected(BaseEventData eventData)
        {
            ...
            while (UnityEngine.Event.PopEvent(m_ProcessingEvent))
            {
