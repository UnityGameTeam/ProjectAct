...
public class UIDecoratorEditor : Editor
{
    ...
    private static Assembly editorAssembly = Assembly.GetAssembly(typeof(GraphicEditor));
    ...
    public UIDecoratorEditor(string editorTypeName,bool checkType = true)
    {
        ...
        if (originalEditedType != editedObjectType && checkType)
        {
