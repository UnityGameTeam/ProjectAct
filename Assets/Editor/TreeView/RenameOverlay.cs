...
public class RenameOverlay
{
    ...
    private static int s_IndentLevel = 1;
    ...
    {
        EditorGUIWrap.s_RecycledEditor.text = m_Name;
        EditorGUIWrap.s_RecycledEditor.SelectAll();
        RepaintClientView();
    ...
    private string DoTextField(string text, GUIStyle textFieldStyle)
    {
        ...
        bool changed;
        return EditorGUIWrap.DoTextField(EditorGUIWrap.s_RecycledEditor, m_TextFieldControlID,
