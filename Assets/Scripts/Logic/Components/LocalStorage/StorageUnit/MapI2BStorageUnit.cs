...
{
    public class MapI2BStorageUnit : LocalStorageUnit
    {
        public static readonly short ValueType = 7;
        ...
        public MapI2BStorageUnit(Dictionary<int, bool> value)
        {
            Value = value;
        }
        ...
        public static KeyValuePair<string, LocalStorageUnit> ParseData(byte[] dataBuff, ref int offset)
        {
            ...
            var value = new Dictionary<int, bool>(valueCount);
            ...
            return new KeyValuePair<string, LocalStorageUnit>(key, new MapI2BStorageUnit(value));
        }
        ...
        public override int ToBinaryData(string key, ref byte[] dataBuff, int offset)
        {
            ...
            var value = Value as Dictionary<int, bool>;
